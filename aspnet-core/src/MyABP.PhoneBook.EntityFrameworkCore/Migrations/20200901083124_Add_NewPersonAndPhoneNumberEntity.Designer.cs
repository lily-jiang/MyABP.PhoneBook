...
namespace MyABP.PhoneBook.Migrations
{
    ...
    [Migration("20200901083124_Add_NewPersonAndPhoneNumberEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyABP.PhoneBook.PhoneBooks.Persons.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyABP.PhoneBook.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyABP.PhoneBook.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyABP.PhoneBook.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyABP.PhoneBook.PhoneBooks.PhoneNumbers.PhoneNumber", b =>
                {
                    b.HasOne("MyABP.PhoneBook.PhoneBooks.Persons.Person", "Person")
                        .WithMany()
